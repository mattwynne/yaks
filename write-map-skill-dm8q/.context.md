...
- Leaf yaks should be implementable in one TDD cycle (20-40 min)
- Growth is bidirectional (down: blockers, up: bigger goals)
- Context pattern: goal, definition of done, known knowns/unknowns
...
- Content covers the full mapping workflow
