...
use crate::application::{
    ...
    ShowContext, ShowField, WriteField,
};
...
mod tests {
    ...
    fn test_add_with_in_memory_adapters() {
        std::env::set_var("YX_IGNORE_STDIN", "1");
